...
def login():
    ...
    if form.validate_on_submit():
        ...
        user_by_name = User.query.filter_by(username=form.email_or_username.data).first()
        ...
        if user_by_name is not None and user_by_name.verify_password(form.password.data):
